...
import {
  ...
  FiAlertCircle, FiX, FiClock, FiUser, FiDownload,
} from "react-icons/fi";
import { formatDate } from "../../../utils/commonUtils";
import { SectionCard, InfoRow, Tag } from "./PatientRecordsComp";
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto bg-slate-50/40 px-4 py-4 space-y-3">
        ...
        <SectionCard icon={FiFileText} title="Prescription" iconColor="text-emerald-600" iconBg="bg-emerald-50">
          ...
          {/* ── View / Download Prescription button ── */}
          {hasPrescription && (
            <button
              onClick={() => setShowRx(true)}
              className="
                mt-4 w-full inline-flex items-center justify-center gap-2
                px-4 py-2.5 rounded-xl border border-[#274760]/20
                bg-[#274760]/6 text-[#274760] text-xs font-bold
                hover:bg-[#274760] hover:text-white hover:border-[#274760]
      ...
      {/* ── Prescription modal (portal-like, renders above the drawer) ── */}
      <PrescriptionModal
