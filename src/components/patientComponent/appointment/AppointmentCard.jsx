...
import { FiCalendar ,FiClock , FiVideo , FiDollarSign ,FiLock, FiCheck , FiAlertCircle } from "react-icons/fi";
                    ...
                    <div className="mt-4 pt-4 border-t border-slate-100 space-y-2">
                        ...
                        {!doctorStartedCall ? (
                            ...
                            <>
                                ...
                                <div className={`flex items-center justify-between rounded-xl px-4 py-2.5 ${isPaid ? "bg-emerald-50 border border-emerald-100" : "bg-amber-50 border border-amber-100"
                                    }`}>
